...
//     mockForm.appendChild(title);
//     mockForm.appendChild(imageUrl);
...
//     jest
//       .spyOn(mockForm, "addEventListener")
//       .mockImplementation((event, handler, options) => console.log(event));

//     jest.spyOn(document, "querySelectorAll").mockReturnValue([mockForm]);

//     const eventSubmit = new Event("submit", {
//       bubbles: true,
//       cancelable: true,
//     });
//     console.log(mockForm.dispatchEvent(eventSubmit));
//     mockForm.dispatchEvent(eventSubmit);
